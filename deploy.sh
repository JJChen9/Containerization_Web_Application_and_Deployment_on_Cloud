...
kubectl set image deployments/client-deployment client=michaelzhu101/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=michaelzhu101/multi-worker:$SHA
